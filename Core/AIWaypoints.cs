...
namespace AI
{
    ...
    public class AIWaypoints : MonoBehaviour
    {
        ...
        public AIEnums.WaypointType WaypointType = AIEnums.WaypointType.InOrder;
       ...
       [HideInInspector] public bool Clicking = false;
        ...
        public class AIWaypointsEditor : Editor
        {
            ...
            public override void OnInspectorGUI()
            {
                ...
                if (((AIWaypoints) target).Clicking && !Application.isPlaying)
                {
                    EditorGUILayout.Space();
