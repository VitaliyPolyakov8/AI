...
public class AIMeleeWeapon : MonoBehaviour
{
    ...
    public class weaponSettings
    {
        ...
        [ReadOnly] public AISystem AISystem = null;
    ...
    public void OnValidate()
    {
        ...
        if (WeaponSettings.AISystem == null)
        {
            ...
            WeaponSettings.AISystem = parentt.GetComponent<AISystem>();
        }
    ...
    private void Awake()
    {
        ...
        WeaponSettings.AISystem.AIEvents.OnDeath.AddListener(OnDeath);
        ...
        OnWeaponStateChanged(WeaponSettings.AlwaysEquipped == AIEnums.YesNo.Yes, true);
        WeaponSettings.AISystem.AlwaysEquipped = WeaponSettings.AlwaysEquipped == AIEnums.YesNo.Yes;
        CheckComponents();
    }
...
#if UNITY_EDITOR
[CustomEditor(typeof(AIMeleeWeapon))]
public class AIMeleeWeaponEditor : Editor
{
    private static readonly string[] _dontIncludeMe = new string[]{"m_Script"};
     
       
    public AIMeleeWeapon MeleeWeapon;
    
    private void OnEnable()
    {
        MeleeWeapon = (AIMeleeWeapon)target;
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (!Application.isPlaying)
        {
            ...
            else if(MeleeWeapon.WeaponSettings.Hitbox.Enabled == AIEnums.YesNo.No && !IgnoreEnabledWarning)
            {
                EditorGUILayout.Space();
                GUI.backgroundColor = new Color(10f, 10f, 0.0f, 0.25f);
