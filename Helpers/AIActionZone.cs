...
public class AIActionZone : MonoBehaviour
{
    [Space]
    ...
    public AIEnums.YesNo ActionZoneEnabled = AIEnums.YesNo.Yes;
    ...
    private AISystem CurrentAISystem;
    private void Start()
    {
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if(CurrentAISystem != null || ActionZoneEnabled == AIEnums.YesNo.No)
            return;
...
[CustomEditor(typeof(AIActionZone))]
