...
#if INTEGRATION_FPV2NEWER && AI_Integration_MMFPSE
using MarsFPSKit;
#endif
...
#if HQ_FPS_TEMPLATE && AI_Integration_HQFPS
using HQFPSTemplate;
#endif

#if SURVIVAL_TEMPLATE_PRO && AI_Integration_STP
using SurvivalTemplatePro;
#endif

#if (INVECTOR_SHOOTER || INVECTOR_MELEE) && AI_Integration_INVECTOR
using Invector;
#endif


#if (FIRST_PERSON_CONTROLLER || THIRD_PERSON_CONTROLLER) && AI_Integration_OPSIVE
using Opsive.UltimateCharacterController.Traits;
using Opsive.UltimateCharacterController.Traits.Damage;
#endif

#if NEOFPS && AI_Integration_NEOFPS
using NeoFPS;
#endif
...
public class AIPlayerReference : MonoBehaviour, AIDamageable
{
    ...
    public AIEnums.YesNo PlayerCanReceiveDamage = AIEnums.YesNo.Yes;
    ...
    public AIEnums.Factions PlayerFaction = AIEnums.Factions.Player;
    ...
    {
        if(PlayerCanReceiveDamage == AIEnums.YesNo.No)
            return;
...
#if UNITY_EDITOR
[CustomEditor(typeof(AIPlayerReference))]
public class AIPlayerReferenceEditor : Editor
{
