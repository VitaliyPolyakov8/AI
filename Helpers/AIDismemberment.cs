...
namespace AI
{
    ...
    [RequireComponent(typeof(AIDamageableObject))]
public class AIDismemberment : MonoBehaviour
{
    [Space]
    [Header("SETTINGS")]
    [Space]
    ...
    public List<AIDismemberment> ChildLimbs = new List<AIDismemberment>();
    [Space] [Space] [Help("The Limbs That Will Also Fall When This Limb Dismembers !", HelpBoxMessageType.Info)]

    public AIEnums.YesNo KillAIOnDismemberment = AIEnums.YesNo.No;
    ...
    [ReadOnly]
    public AIDamageableObject DamageableObject;
    ...
    private void OnValidate()
    {
        ...
        {
            DamageableObject = GetComponent<AIDamageableObject>();
        }
    }
    ...
    public void TakeDamage(float damage)
    {
        ...
        if (Durability <= 0)
        {
            ...
            if (KillAIOnDismemberment == AIEnums.YesNo.Yes)
            {
                if (GetComponent<AIDamageableObject>() != null)
                {
                    GetComponent<AIDamageableObject>().TakeDamage(9999, AttackerType.Other, null);
                }
            }
...
[CustomEditor(typeof(AIDismemberment))]
public class AIDismembermentEditor : Editor
{
