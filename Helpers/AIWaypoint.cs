...
{
     [Space]
     public AIEnums.YesNo EnableGizmos = AIEnums.YesNo.Yes;
     [Space]
     
     public AIEnums.YesNo AlignWithFloor = AIEnums.YesNo.Yes;
     ...
     {
         if (AlignWithFloor == AIEnums.YesNo.Yes)
         {
             RaycastHit hit;
    ...
    {
        if(EnableGizmos == AIEnums.YesNo.No)
            return;
